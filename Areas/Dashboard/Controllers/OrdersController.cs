...
namespace e_commercee.Areas.Dashboard.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,Status,AddressId,Amount,CreatedAt")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserId,Status,AddressId,Amount,CreatedAt")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
